...
class apb_write_txn_gen extends apb_gen;
	...
	task gen;
		...
		for (int i=1; i <= 1; i++) begin
            // First transaction: write_setup_txn with psel = 1, penable = 0
            write_setup_txn = new();
            ...
            // Second transaction: write_ready_txn with psel = 1, penable = 1, and matching other fields
            write_ready_txn = new();
            write_ready_txn = write_setup_txn.clone();  // Copy fields from write_setup_txn
